...
public class LoginActivity extends Activity {
    ...
    public void register(View v) {
        ...
        EditText registerPwd = (EditText) findViewById(R.id.register_password);
        EditText registerPwd2 = (EditText) findViewById(R.id.register_password_again);

        if(TextUtils.isEmpty(registerEmail.getEditableText().toString())) {
        ...
        if(focusView != null) {
            ...
            if(!registerPwd.getEditableText().toString().equals(registerPwd2.getEditableText().toString())) {
